...
bool JPLCometFile::processLine(const char * line) {
    ...
    s_designation.assign(line,0,43);
    removeLeadingAndTrailingSpaces(s_designation);
  
    // ORSA_DEBUG("des: %s",s_designation.c_str());
  
    s_epoch_MJD.assign(line,44,7);
  
    s_q.assign(line,52,11);
    s_e.assign(line,64,10);
    s_i.assign(line,75,9);
    s_peri.assign(line,85,9);
    s_node.assign(line,95,9);
  
    s_Tp_y.assign(line,105,4);
    s_Tp_m.assign(line,109,2);
    s_Tp_d.assign(line,111,8);
