...
#warning check code for HIGH degree, might have to rewrite linear algebra...
    ...
    
    {
        ...
        */
            ...
            if (massDistribution.get() == 0) {
                ...
                */
                ...
                if ("IzzMR2" == ref_key) {
                    ...
                    uniformShape_coeff = uniformShapeMassFraction*uniformShape_IzzMR2.get_d();
                }
            }
        ...
        if (0) {
            ORSA_DEBUG("WARNING: siman code has not been kept up-to-date, please review carefully before use...");
            sleep(5);
...
#warning check this, factors & normalizations have changed since last time this was used...
        ...
        if (1) {
            ...
            m3->uniformShape_IzzMR2 = uniformShape_IzzMR2;
...
double E1(void * xp) {
    ...
    for (size_t i=0; i<x->M; ++i) {
        ...
        */
        ...
        if ("IzzMR2" == ref_key) {
            layer_coeff        =  layersTotalMassFraction*layerData_IzzMR2.get_d();
            uniformShape_coeff = uniformShapeMassFraction*x->uniformShape_IzzMR2.get_d();
        }
        if (!layer_coeff.isSet()) {
            ORSA_DEBUG("problems...");
            exit(0);
