...
// this means that C00=1, and C10=C11=S11=0 and C21=S21=0 and there are no other coefficients
// this is useful when only GM is known, and we also know the CM position and the rotation axis direction
// bool early_mode;
